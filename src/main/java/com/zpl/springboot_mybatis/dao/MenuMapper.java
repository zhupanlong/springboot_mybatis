...
import com.zpl.springboot_mybatis.model.Menu;
import com.zpl.springboot_mybatis.model.MenuExample;
...
public interface MenuMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.MenuMapper.BaseResultMap")
