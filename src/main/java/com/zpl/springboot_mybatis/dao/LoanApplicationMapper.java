package com.zpl.springboot_mybatis.dao;

import com.zpl.springboot_mybatis.model.LoanApplication;
import com.zpl.springboot_mybatis.model.LoanApplicationExample;
...
public interface LoanApplicationMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.LoanApplicationMapper.BaseResultMap")
