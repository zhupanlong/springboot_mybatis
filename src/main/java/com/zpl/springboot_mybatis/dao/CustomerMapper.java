...
import com.zpl.springboot_mybatis.model.Customer;
import com.zpl.springboot_mybatis.model.CustomerExample;
...
public interface CustomerMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.CustomerMapper.BaseResultMap")
