...
import com.zpl.springboot_mybatis.model.Tree;
import com.zpl.springboot_mybatis.model.TreeExample;
...
public interface TreeMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.TreeMapper.BaseResultMap")
