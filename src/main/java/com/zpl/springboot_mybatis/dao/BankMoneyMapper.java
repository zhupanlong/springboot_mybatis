...
import com.zpl.springboot_mybatis.model.BankMoney;
import com.zpl.springboot_mybatis.model.BankMoneyExample;
...
public interface BankMoneyMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.BankMoneyMapper.BaseResultMap")
