...
import com.zpl.springboot_mybatis.model.Deduct;
import com.zpl.springboot_mybatis.model.DeductExample;
...
public interface DeductMapper extends DAO {
    ...
    @ResultMap("com.zpl.springboot_mybatis.dao.DeductMapper.BaseResultMap")
